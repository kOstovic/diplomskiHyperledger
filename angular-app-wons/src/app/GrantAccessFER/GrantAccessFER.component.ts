...
import { GrantAccessFERService } from './GrantAccessFER.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-GrantAccessFER',
	templateUrl: './GrantAccessFER.component.html',
	styleUrls: ['./GrantAccessFER.component.css'],
  providers: [GrantAccessFERService]
})
export class GrantAccessFERComponent implements OnInit {
  ...
  constructor(private serviceGrantAccessFER:GrantAccessFERService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceGrantAccessFER.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    return this.serviceGrantAccessFER.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceGrantAccessFER.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceGrantAccessFER.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceGrantAccessFER.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
